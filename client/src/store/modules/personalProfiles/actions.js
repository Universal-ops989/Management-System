...
export default {
  async fetchProfiles({ commit, state }) {
    ...
    try {
      ...
      const response = await profileService.fetchPersonalProfiles(filters);
  ...
  async fetchProfile({ commit }, profileId) {
    ...
    try {
      const response = await profileService.getPersonalProfile(profileId);
  ...
  async createProfile({ commit, dispatch }, profileData) {
    ...
    try {
      const response = await profileService.createPersonalProfile(profileData);
  ...
  async updateProfile({ commit, state }, { profileId, profileData }) {
    ...
    try {
      const response = await profileService.updatePersonalProfile(profileId, profileData);
  ...
  async deleteProfile({ commit, state }, profileId) {
    ...
    try {
      const response = await profileService.deletePersonalProfile(profileId);
