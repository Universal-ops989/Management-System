...
export default {
  async fetchProfiles({ commit, state }) {
    ...
    try {
      ...
      const response = await profileService.fetchJobProfiles(filters);
  ...
  async fetchProfile({ commit }, profileId) {
    ...
    try {
      const response = await profileService.getJobProfile(profileId);
  ...
  async createProfile({ commit, dispatch }, profileData) {
    ...
    try {
      const response = await profileService.createJobProfile(profileData);
  ...
  async updateProfile({ commit, state }, { profileId, profileData }) {
    ...
    try {
      const response = await profileService.updateJobProfile(profileId, profileData);
  ...
  async deleteProfile({ commit, state }, profileId) {
    ...
    try {
      const response = await profileService.deleteJobProfile(profileId);
